#!/usr/bin/env python
# $Id: test_nodeinstaller.py 3135 2009-10-23 05:42:58Z ltsai $
#
...
from primitive.nodeinstall.errors import ParseNIISourceError
...
#        assert translatePartitionOptions(options1,'preserve')[0] is True        
    ...
    def testKickstartFromNIIProfile(self):
        ...
        assert ksprofile.networkprofile['fqhn_host'] == 'node0000.myzone.company.com'
