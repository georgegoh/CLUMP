#!/usr/bin/env python
# $Id: test_partitionschema.py 3135 2009-10-23 05:42:58Z ltsai $
#
...
#
from primitive.nodeinstall.nodeinstall import NodeInstaller, KickstartFromNIIProfile
from primitive.nodeinstall.partition import  adaptNIIPartition, translatePartitionOptions
...
import os
from primitive.system.hardware.partitiontool import DiskProfile, Disk, Partition
from primitive.nodeinstall.defaults import Disk as SchemaDisk
from primitive.nodeinstall.defaults import Partition as SchemaPartition
from primitive.nodeinstall.defaults import LVMGroup as SchemaLVMGroup
from primitive.nodeinstall.defaults import LVMLogicalVolume as SchemaLVMLogicalVolume
from primitive.nodeinstall.defaults import DiskCollection, LVMCollection, PartitionSchema
...
class TestNIIPartition:
    ...
    def setUp(self):
        raise SkipTest, 'Skip tests for now'
