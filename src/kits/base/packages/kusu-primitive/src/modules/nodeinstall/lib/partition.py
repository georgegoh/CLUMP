#!/usr/bin/env python
# $Id: partition.py 3135 2009-10-23 05:42:58Z ltsai $
#
...
from primitive.nodeinstall.errors import InvalidPartitionSchema

from primitive.support import compat
from primitive.nodeinstall.partitionfilterchain import *
#XXX port this
from primitive.nodeinstall.defaults import getPartitionTuple
#XXXX
...
logger = logger = primitive.support.log.getPrimitiveLog('nodeinstall.Partition')
