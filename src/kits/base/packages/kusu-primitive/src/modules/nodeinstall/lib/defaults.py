#!/usr/bin/env python
#
# $Id: defaults.py 3135 2009-10-23 05:42:58Z ltsai $
#
...
from primitive.support.errors import *
...
import struct # built in struct
logger = primitive.support.log.getPrimitiveLog('nodeinstall.defaults')
from primitive.system.hardware.errors import * # all the long legacy errors 
