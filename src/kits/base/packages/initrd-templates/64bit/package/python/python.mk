...
BR2_PYTHON_DISABLED_MODULES=readline dbm gdbm bsddb \
...
$(TARGET_DIR)/$(PYTHON_TARGET_BINARY): $(PYTHON_DIR)/$(PYTHON_BINARY)
	...
	mkdir -p $(STAGING_DIR)/include/python2.4
	cp -v $(PYTHON_DIR)/pyconfig.h $(STAGING_DIR)/include/python2.4
	cp -v $(PYTHON_DIR)/Include/*.h $(STAGING_DIR)/include/python2.4
