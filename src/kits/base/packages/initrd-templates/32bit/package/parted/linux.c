            ...
            PedSector count)
{
	...
	/*  MARK Broke this        if (posix_memalign (&diobuf, dev->sector_size, read_length) != 0)
                return 0;
	*/
	if((diobuf = memalign(dev->sector_size, read_length)) == NULL)
		return 0 ;
...
/*        if (posix_memalign(&diobuf, PED_SECTOR_SIZE_DEFAULT,
                ...
                return 0;
*/
        if ((diobuf = memalign(PED_SECTOR_SIZE_DEFAULT, count * PED_SECTOR_SIZE_DEFAULT)) == NULL)
                return 0;
