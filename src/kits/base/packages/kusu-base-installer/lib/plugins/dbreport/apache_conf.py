...
class thisReport(dbreport.Report):
    ...
    def toolHelp(self):
        ...
        print self.gettext("dbreport_Apache_Help")
    ...
    def runPlugin(self, pluginargs):
        ...
        if not cfmdir:
            sys.stderr.write(_("dbreport_cannot_determine_cfmbasedir\n"))
            sys.exit(-1)
        ...
        print '\tSetEnv PYTHONPATH /opt/ocs/lib'
