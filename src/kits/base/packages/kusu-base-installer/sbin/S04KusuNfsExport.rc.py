#!/usr/bin/env python
# $Id: S04KusuNfsExport.rc.py 3499 2010-02-09 10:28:36Z mkchew $
#
...
class KusuRC(rcplugin.Plugin):
    ...
    def run(self):
        ...
        shared_paths = [ path(p) for p in ['/home', '/depot/shared'] ]
        for p in shared_paths:
            if not p.exists():
                p.makedirs()

        # Set up symlink from /depot/shared to /shared
        path('/depot/shared').symlink('/shared')
