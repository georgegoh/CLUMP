#!/usr/bin/env python
# $Id: S03KusuIptables.rc.py 3135 2009-10-23 05:42:58Z ltsai $
#
...
class KusuRC(rcplugin.Plugin):
    ...
    def generateIPTablesConfig(self, devices_by_network_name):
        ...
        if not devices_by_network_name.public:
            print >>sys.stderr, "\nWARNING: this host only has one NIC.\n\nPlease consult documentation regarding installation pre-requisites"
            return None
