...
install -m644 lib/sles/languages.py $RPM_BUILD_ROOT/%{_approot}/lib/python/kusu/installer
install -m644 lib/sles/timezones.py $RPM_BUILD_ROOT/%{_approot}/lib/python/kusu/installer
install -m644 lib/sles/keyboards.py $RPM_BUILD_ROOT/%{_approot}/lib/python/kusu/installer
