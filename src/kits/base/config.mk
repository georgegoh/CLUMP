...
PKG_BASE_INSTALLER_SOURCES = locale lib sbin bin sql man
...
# Kusu Core package.
KIT_PKGS += PKG_PARTITIONTOOL
PKG_PARTITIONTOOL_SPEC = kusu-partitiontool.spec
PKG_PARTITIONTOOL_SOURCES = doc src/lib
PKG_PARTITIONTOOL_TARBALL_SUBVER = 4
...
PKG_NODEINSTALLER_PATCHFILES_SOURCES = src sbin bin kusurc man
PKG_NODEINSTALLER_PATCHFILES_TARBALL_SUBVER = 6

# Kusu Node Installer Patchfiles package.
KIT_PKGS += PKG_RELEASE
PKG_NODEINSTALLER_PATCHFILES_SPEC = kusu-release.spec
PKG_NODEINSTALLER_PATCHFILES_SOURCES = src 
PKG_NODEINSTALLER_PATCHFILES_TARBALL_SUBVER = 1
