...
Requires: kusu-kitops >= 0.3
Requires: kusu-networktool >= 0.3
Requires: kusu-path >= 0.3
Requires: kusu-repoman >= 0.3
Requires: kusu-sqlalchemy >= 0.3
Requires: kusu-ui >= 0.3
Requires: kusu-util >= 0.3
Requires: kusu-nodeinstaller-patchfiles >= 0.3
Requires: mysql >= 5.0
