...
#            self.ctx.set_current(sa.orm.mapper_registry.get(ClassKey(ReposHaveKits, self.entity_name)).get_session())
    ...
    def bootstrap(self):
        ...
        imaged.modules.append(Modules(loadorder=8,module='libata'))
        imaged.modules.append(Modules(loadorder=9,module='ata_piix'))
        imaged.modules.append(Modules(loadorder=10,module='sata_svw'))
        imaged.modules.append(Modules(loadorder=11,module='sata_nv'))
        imaged.modules.append(Modules(loadorder=12,module='ahci'))
        imaged.modules.append(Modules(loadorder=13,module='mptbase'))
        imaged.modules.append(Modules(loadorder=14,module='mptscsih'))
        imaged.modules.append(Modules(loadorder=15,module='scsi_transport_sas'))
        imaged.modules.append(Modules(loadorder=16,module='scsi_transport_fc'))
        imaged.modules.append(Modules(loadorder=17,module='scsi_transport_spi'))
        imaged.modules.append(Modules(loadorder=18,module='mptsas'))
        imaged.modules.append(Modules(loadorder=19,module='mptfc'))
        imaged.modules.append(Modules(loadorder=20,module='mptspi'))
        imaged.modules.append(Modules(loadorder=21,module='jbd'))
        imaged.modules.append(Modules(loadorder=22,module='lockd'))
        imaged.modules.append(Modules(loadorder=23,module='fscache'))
        imaged.modules.append(Modules(loadorder=24,module='nfs_acl'))
        imaged.modules.append(Modules(loadorder=25,module='sunrpc'))
        imaged.modules.append(Modules(loadorder=26,module='mii'))
        imaged.modules.append(Modules(loadorder=27,module='e100'))
        imaged.modules.append(Modules(loadorder=28,module='pcnet32'))
        imaged.modules.append(Modules(loadorder=29,module='forcedeth'))
        imaged.modules.append(Modules(loadorder=30,module='autofs4'))
