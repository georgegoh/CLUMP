...
class Screen1(screenfactory.BaseScreen):
...
if __name__ == '__main__':
    ...
    ks = navigator.Navigator(screenFactory, "Navigator Sample", True)
    ks.run()
