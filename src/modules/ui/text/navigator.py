...
class PlatformScreen(snack.SnackScreen):
    ...
    def __init__(self, title,
                 helpLine=_('Copyright(C) 2007 Platform Computing Inc.\t\t' + \
                         'Press F12 to quit')):
...
class Navigator(object):
    ...
    def draw(self):
        ...
        form = snack.Form(_("This is the help statement"))
